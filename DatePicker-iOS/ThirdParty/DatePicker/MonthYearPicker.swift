...
extension MonthYearPicker: UIPickerViewDelegate {
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        var selectedYear = yearRange.lowerBound + pickerView.selectedRow(inComponent: Component.year.rawValue)
        var selectedMonth = monthRange.lowerBound + pickerView.selectedRow(inComponent: Component.month.rawValue)
        
        // Check if user selected a future year or month
        if selectedYear > currentYear || (selectedYear == currentYear && selectedMonth > currentMonth) {
            
            if !self.isSelectFutureMonth {
                // Set selected year and month to current year and month
                selectedYear = currentYear
                selectedMonth = currentMonth
            }
            
            // Set picker view to current year and month
            pickerView.selectRow(currentYear - yearRange.lowerBound, inComponent: Component.year.rawValue, animated: true)
            pickerView.selectRow(currentMonth - monthRange.lowerBound, inComponent: Component.month.rawValue, animated: true)
        }
