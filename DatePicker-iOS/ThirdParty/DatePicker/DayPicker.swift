...
extension DayPicker: UIPickerViewDelegate {
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if self.isSelectFutureDate {
            ...
            if date > Date() { // check if selected date is in the future
                pickerView.selectRow(calendar.component(.year, from: Date()) - yearRange.lowerBound, inComponent: Component.year.rawValue, animated: true)
                pickerView.selectRow(calendar.component(.month, from: Date()) - monthRange.lowerBound, inComponent: Component.month.rawValue, animated: true)
                pickerView.selectRow(calendar.component(.day, from: Date()) - dayRange.lowerBound, inComponent: Component.day.rawValue, animated: true)
